...
// v0 scaffold for: No AI accessibility-score generation
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-ai-accessibility-score-generation/run.

export default function AiAccessibilityScoreGenerationPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-ai-accessibility-score-generation/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No AI accessibility-score generation</h1>
