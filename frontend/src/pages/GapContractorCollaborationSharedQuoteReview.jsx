...
// v0 scaffold for: No contractor collaboration on shared quote review
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-contractor-collaboration-shared-quote-review/run.

export default function ContractorCollaborationSharedQuoteReviewPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-contractor-collaboration-shared-quote-review/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No contractor collaboration on shared quote review</h1>
