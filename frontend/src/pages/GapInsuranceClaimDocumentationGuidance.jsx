...
// v0 scaffold for: No insurance-claim documentation guidance
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-insurance-claim-documentation-guidance/run.

export default function InsuranceClaimDocumentationGuidancePage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-insurance-claim-documentation-guidance/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No insurance-claim documentation guidance</h1>
