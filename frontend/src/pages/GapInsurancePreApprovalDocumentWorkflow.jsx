...
// v0 scaffold for: Insurance pre-approval document workflow
// Generated by batch_00 audit. Wire to real API; v0 calls /api/cf-insurance-pre-approval-document-workflow/run.

export default function InsurancePreApprovalDocumentWorkflowPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/cf-insurance-pre-approval-document-workflow/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>Insurance pre-approval document workflow</h1>
