...
// v0 scaffold for: No photo upload for image-based home assessment
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-photo-upload-image-based-home/run.

export default function PhotoUploadImageBasedHomePage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-photo-upload-image-based-home/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No photo upload for image-based home assessment</h1>
