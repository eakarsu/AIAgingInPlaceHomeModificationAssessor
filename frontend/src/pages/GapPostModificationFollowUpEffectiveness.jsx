...
// v0 scaffold for: No post-modification follow-up / effectiveness tracking
// Generated by batch_00 audit. Wire to real API; v0 calls /api/gap-post-modification-follow-up-effectiveness/run.

export default function PostModificationFollowUpEffectivenessPage() {
  ...
  async function run() {
    ...
    try {
      ...
      const res = await fetch('/api/gap-post-modification-follow-up-effectiveness/run', {
        method: 'POST',
        headers: {
  ...
  return (
    <div style={{ padding: '2rem', maxWidth: '900px', margin: '0 auto' }}>
      <h1 style={{ fontSize: '1.5rem', fontWeight: 600, marginBottom: '0.5rem' }}>No post-modification follow-up / effectiveness tracking</h1>
